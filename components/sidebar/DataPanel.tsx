...
import { TrendingUp, AlertTriangle, Lightbulb, ArrowRight, BarChart2, LineChart, Loader2, Upload, RefreshCw } from 'lucide-react'
    ...
    <div className="flex flex-col h-full overflow-hidden" style={{ background: '#1a1a1a' }}>
      ...
      >
        <div>
          ...
          <p className="text-[10px]" style={{ color: '#555' }}>Paste metrics or CSV → AI interprets</p>
        </div>
        {result && (
          <button
            onClick={reset}

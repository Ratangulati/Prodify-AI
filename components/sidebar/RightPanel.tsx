...
export default function RightPanel() {
  ...
  if (collapsed) {
    return (
      <div
        className="flex flex-col items-center py-4 gap-4 border-l"
        style={{ width: 44, background: '#1a1a1a', borderColor: '#2a2a2a' }}
      >
        <button
  ...
  return (
    <aside
      ...
      style={{ width: 380, minWidth: 380, background: '#1a1a1a', borderColor: '#2a2a2a' }}
    >
      {/* Tab bar */}
      <div
